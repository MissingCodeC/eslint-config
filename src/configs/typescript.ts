...
const rules = {
  ...
  'ts/consistent-type-definitions': ['warn', 'interface'], // Enforce type definitions to consistently use either interface or type
...
function typescript() {
  ...
  const isTypeAware = existsSync(tsconfig)
